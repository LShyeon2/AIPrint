...
{
    public partial class OperatorLogView : System.Windows.Controls.Page
    {
        #region Variable
        #region Field
        private string strtag = string.Empty;
        private ViewModelOperatorLogView vm;
        #endregion
        ...
        {
            InitializeComponent();
            vm = new ViewModelOperatorLogView();
            //DataContext = this;
            DataContext = vm;
            ...
            {
                case "ko-KR":
                    LogGrid.Columns[3].Visibility = Visibility.Visible;
                    LogGrid.Columns[4].Visibility = Visibility.Hidden;
                    LogGrid.Columns[5].Visibility = Visibility.Hidden;
                    LogGrid.Columns[6].Visibility = Visibility.Hidden;
                    ...
                    LogGrid.Columns[11].Visibility = Visibility.Visible;
                    LogGrid.Columns[12].Visibility = Visibility.Hidden;
                    LogGrid.Columns[13].Visibility = Visibility.Hidden;
                    LogGrid.Columns[14].Visibility = Visibility.Hidden;
                    break;
                case "en-US":
                    LogGrid.Columns[3].Visibility = Visibility.Hidden;
                    LogGrid.Columns[4].Visibility = Visibility.Visible;
                    LogGrid.Columns[5].Visibility = Visibility.Hidden;
                    LogGrid.Columns[6].Visibility = Visibility.Hidden;
                    ...
                    LogGrid.Columns[11].Visibility = Visibility.Hidden;
                    LogGrid.Columns[12].Visibility = Visibility.Visible;
                    LogGrid.Columns[13].Visibility = Visibility.Hidden;
                    LogGrid.Columns[14].Visibility = Visibility.Hidden;
                    break;
                case "zh-CN":
                    LogGrid.Columns[3].Visibility = Visibility.Hidden;
                    LogGrid.Columns[4].Visibility = Visibility.Hidden;
                    LogGrid.Columns[5].Visibility = Visibility.Visible;
                    LogGrid.Columns[6].Visibility = Visibility.Hidden;
                    ...
                    LogGrid.Columns[11].Visibility = Visibility.Hidden;
                    LogGrid.Columns[12].Visibility = Visibility.Hidden;
                    LogGrid.Columns[13].Visibility = Visibility.Visible;
                    LogGrid.Columns[14].Visibility = Visibility.Hidden;
                    break;
                case "hu-HU":
                    LogGrid.Columns[3].Visibility = Visibility.Hidden;
                    LogGrid.Columns[4].Visibility = Visibility.Hidden;
                    LogGrid.Columns[5].Visibility = Visibility.Hidden;
                    LogGrid.Columns[6].Visibility = Visibility.Visible;
                    ...
                    LogGrid.Columns[12].Visibility = Visibility.Hidden;
                    LogGrid.Columns[13].Visibility = Visibility.Hidden;
                    LogGrid.Columns[14].Visibility = Visibility.Visible;
                    break;
            }
        }
        #endregion
        ...
        {
            if (GlobalData.Current.LoginUserAuthority.Contains("ModifyOperatorLog"))
            {
        ...
        private void ButtonControl_Click(object sender, RoutedEventArgs e)
        {
            try //240404 RGJ 클릭 이벤트 예외 못잡으면 프로그램 다운 되므로 전부 예외처리함.
            {
                ...
                {
                    LogManager.WriteOperatorLog(string.Format("사용자가 {0} {1} 을/를 Click하였습니다.", "Operator Log", senderBuffer.Tag.ToString()),
                        ...
                        "Operator Log", senderBuffer.Tag.ToString());
                }
            }
            catch (Exception ex)
            {
