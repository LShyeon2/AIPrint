...
namespace BoxPrint.GUI.Views
{
    ...
    /// </summary>
    public partial class HSMSLogView : System.Windows.Controls.Page
    {
        #region Variable
        #region Field
        private string strtag = string.Empty;
        private ViewModelHSMSLogView vm;
        #endregion
        ...
        private void ButtonControl_Click(object sender, RoutedEventArgs e)
        {
            try //240404 RGJ 클릭 이벤트 예외 못잡으면 프로그램 다운 되므로 전부 예외처리함.
            {
                ...
                {
                    LogManager.WriteOperatorLog(string.Format("사용자가 {0} {1} 을/를 Click하였습니다.", "HSMS Log", senderBuffer.Tag.ToString()),
                        ...
                        "HSMS Log", senderBuffer.Tag.ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        {
            if (GlobalData.Current.LoginUserAuthority.Contains("ModifyHSMSLog"))
            {
