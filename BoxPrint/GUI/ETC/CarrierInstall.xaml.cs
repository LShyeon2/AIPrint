...
namespace BoxPrint.GUI.ETC
{
    ...
    /// </summary>
    public partial class CarrierInstall : Window
    {
        private bool bResult = false;
        private CarrierInstallViewModel vm;

        public CarrierInstall(string tag)
        {
            InitializeComponent();

            vm = new CarrierInstallViewModel(tag);
            DataContext = vm;
