...
namespace BoxPrint.GUI.ETC.LoadingPopup
{
    public class CircularProgressBar : ProgressBar
    {
        ...
        public eStrokeMode StrokeMode
        {
            get { return (eStrokeMode)GetValue(StrokeModeProperty); }
            set { SetValue(StrokeModeProperty, value); }
        }
        public static readonly DependencyProperty StrokeModeProperty =
            DependencyProperty.Register(nameof(StrokeMode), typeof(eStrokeMode), typeof(CircularProgressBar), new PropertyMetadata(eStrokeMode.Middle));

    }

    public enum eStrokeMode
    {
        Middle,
        Inside,
        Outside,
