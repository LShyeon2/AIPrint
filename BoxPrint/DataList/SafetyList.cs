...
namespace BoxPrint.DataList
{
    ...
    /// </summary>
    public class SAFERTYIOPoint : INotifyPropertyChanged
    {
        /// <summary>
        /// IO 접점이 속한 Module ID
        /// </summary>
    ...
    /// </summary>
    [XmlRoot("SAFERTYIOPointList")]
    public class SAFERTYIOPointList : ICollection<SAFERTYIOPoint>
    {
        private static Object thisLock = new Object();

        private List<SAFERTYIOPoint> _ioPointList = new List<SAFERTYIOPoint>();
        ...
        public SAFERTYIOPoint this[int i]
        {
            get
            {
        ...
        /// <returns>IOPoint</returns>
        public SAFERTYIOPoint this[string moduleID, string name]
        {
            get
            {
        ...
        public static void Serialize(string fileName, SAFERTYIOPointList ioPointList)
        {
            lock (thisLock)
            {
                ...
                try
                {
                    XmlSerializer xmlSer = new XmlSerializer(typeof(SAFERTYIOPointList));
        ...
        public static SAFERTYIOPointList Deserialize(string fileName)
        {
            bool bSuccess = false;
            int nLoopCnt = 0;
            SAFERTYIOPointList ioPointList = null;
            ...
            lock (thisLock)
            {
                ...
                while (!bSuccess && nLoopCnt < 5)
                {
                    try
                    {
                        ...
                        ioPointList = (SAFERTYIOPointList)xmlSer.Deserialize(fs);
                        fs.Close();
        ...
        public void Add(SAFERTYIOPoint item)
        {
        ...
        public bool Contains(SAFERTYIOPoint item)
        {
            return _ioPointList.Contains(item);
        }

        public void CopyTo(SAFERTYIOPoint[] array, int arrayIndex)
        {
        ...
        public bool Remove(SAFERTYIOPoint item)
        {
        ...
        public IEnumerator<SAFERTYIOPoint> GetEnumerator()
        {
